...
export default function Page() {
  ...
  if (isLoading) return <DashboardLayout navigationItems={navigationItems} userRole="hod"><LoadingState message="Loading..." /></DashboardLayout>;
  if (error) return <DashboardLayout navigationItems={navigationItems} userRole="hod"><ErrorState title="Error" description="Failed to load data." error={error} onRetry={() => window.location.reload()} /></DashboardLayout>;
